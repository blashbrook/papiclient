...
namespace Blashbrook\PAPIClient\Livewire\Select\Flux;
...
/**
 * Livewire component for selecting a Delivery Option using a Flux radio field.
 *
 ...
 */
class DeliveryOptionRadio extends Component
{
    ...
    public function render()
    {
        ...
        return view('papiclient::livewire.select.flux.delivery-option-radio', [
